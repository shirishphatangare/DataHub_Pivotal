...
public interface EmployeeServiceProxy {
	...
	@GetMapping(value="/employee/find/{id}") // Prefixing service name as defined in Eureka is required when zuul gateway is used 
	public EmployeeInfo getEmployeeData(@PathVariable("id") Long id, @RequestHeader("Authorization") String bearerToken);
	//public EmployeeInfo getEmployeeData(@PathVariable("id") Long id);
